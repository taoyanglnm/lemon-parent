              ...
              <div class="row" style="padding:10px;">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="row">
							  <div class="col-md-10">
	                             <a href="${ctx}/product/type">产品类别</a>
	                             <c:if test="${!empty pager.datas[0].parent.parent.typeid}">
	                              <a href="${ctx}/product/type?parentId=${pager.datas[0].parent.parent.typeid}">
	                          	      / ${pager.datas[0].parent.parent.name}                              
	                               </a>
	                             </c:if>
							  </div>
							  <div class="col-md-2">							  
							   <a href="${ctx}/product/type/new?parentId=${param.parentId}">
                                <button type="button" class="btn btn-sm"><i class="icon-plus-sign"></i> 
                                                                                                    新增
                                </button>
                               </a>                                                   
                               <a href="#" onclick="alert('尚未实现改功能');" >
                       ...
                       <!-- row end-->	                            
                          ...
                          <table class="table table-condensed table-striped table-advance table-hover table-bordered">
		                      ...
		                      <c:forEach items="${pager.datas}" var="entity">
								<tr>
									...
									<td>${entity.note}</td>
									<td>
									 <button class="btn btn-xs" onclick="crud('product/type/${entity.typeid}','show');"><i class="icon-lemon"></i></button>
		                             <button class="btn btn-xs" onclick="crud('product/type/${entity.typeid}/edit','edit');"><i class="icon-pencil"></i></button>
		                             <button class="btn btn-xs" onclick="crud('product/type/${entity.typeid}/delete','delete');"><i class="icon-trash "></i></button>
									</td>
								</tr>
							 </c:forEach>	
                              </tbody>
                         ...
                         <div class="col-md-offset-9" style="text-align:right;">  
						     ...
						     <jsp:param value="${param.parentId}" name="parentId"/>
						     <jsp:param value="${ctx}/product/type" name="url"/>
					       </jsp:include>					       
                          </div>                       
                      </section>
                  </div>
