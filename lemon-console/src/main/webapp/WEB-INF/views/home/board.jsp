...
<head> 
   ...
   <!--external css-->
    ...
    <link href="${ctx}/res/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="${ctx}/res/css/owl.carousel.css" type="text/css">
...
<body>
          ...
          <!--main content start-->
              ...
              <div class="row state-overview" style="padding-top:50px;">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="../res/img/avatar1.jpg" alt="">
                              </a>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="${ctx }/res/img/sm-img-1.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${ctx }/res/img/sm-img-2.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${ctx }/res/img/sm-img-3.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${ctx }/res/img/sm-img-1.jpg">
                                                          </a>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="${ctx }/res/img/follower-avatar.jpg" alt="">
                                          </div>
                                      </div>
                                  </div>
    ...
    <script src="${ctx}/res/js/jquery-1.8.3.min.js"></script>
    ...
    <script src="${ctx}/res/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="${ctx}/res/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="${ctx}/res/js/owl.carousel.js" ></script>
    <script src="${ctx}/res/js/jquery.customSelect.min.js" ></script>

    <!--common script for all pages-->
    <script src="${ctx}/res/js/common-scripts.js"></script>

    <!--script for this page-->
    <script src="${ctx}/res/js/sparkline-chart.js"></script>
    <script src="${ctx}/res/js/easy-pie-chart.js"></script>
<script>
