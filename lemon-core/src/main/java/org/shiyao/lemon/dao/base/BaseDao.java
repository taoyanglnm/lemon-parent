...
package org.shiyao.lemon.dao.base;
...
public class BaseDao<T> implements IBaseDao<T> {
	...
	//@Resource注解在字段上，这样就不用写setter方法了 //@Autowired
	@Resource	
	...
	public void delete(Serializable id) {
		getSession().delete(getSession().load(getClz(), id));
	}
	...
	private String initSort(String hql) {
		String order = PaginationContext.getOrder();
		String sort = PaginationContext.getSort();
	...
	private void setPagers(Query query,Pager pages) {
		...
		Integer pageOffset = PaginationContext.getPageOffset();
